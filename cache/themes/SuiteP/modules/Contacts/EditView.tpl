...
<textarea id="primary_address_street" name="primary_address_street" maxlength="150"
                          rows="2"
                          cols="30"   >{$fields.primary_address_street.value}</textarea>
</td>
</tr>
<tr>
...
maxlength='150'                       value='{$fields.primary_address_postalcode.value}' >
</td>
</tr>
<tr>
...
<textarea id="alt_address_street" name="alt_address_street" maxlength="150"
                          rows="2"
                          cols="30"   >{$fields.alt_address_street.value}</textarea>
</td>
</tr>
<tr>
...
maxlength='150'                       value='{$fields.alt_address_postalcode.value}' >
</td>
</tr>
<tr>
