...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'include/SugarFields/Fields/Address/EditView.tpl', 43, false),array('modifier', 'cat', 'include/SugarFields/Fields/Address/EditView.tpl', 44, false),array('modifier', 'lower', 'include/SugarFields/Fields/Address/EditView.tpl', 55, false),array('modifier', 'in_array', 'include/SugarFields/Fields/Address/EditView.tpl', 55, false),array('modifier', 'default', 'include/SugarFields/Fields/Address/EditView.tpl', 62, false),)), $this); ?>
{*
/**
 *
...
" <?php if (! empty ( $this->_tpl_vars['tabindex'] )): ?>
                          tabindex="<?php echo $this->_tpl_vars['tabindex']; ?>
" <?php endif; ?> <?php if (! empty ( $this->_tpl_vars['displayParams']['accesskey'] )): ?>
...
'<?php endif; ?>
                       value='{$fields.<?php echo $this->_tpl_vars['city']; ?>
...
"
                       <?php if (! empty ( $this->_tpl_vars['vardef']['len'] )): ?>maxlength='<?php echo $this->_tpl_vars['vardef']['len']; ?>
'<?php endif; ?>
                       value='{$fields.<?php echo $this->_tpl_vars['state']; ?>
.value}' <?php if (! empty ( $this->_tpl_vars['tabindex'] )): ?> tabindex="<?php echo $this->_tpl_vars['tabindex']; ?>
" <?php endif; ?>>
            </td>
        </tr>
...
.value}' <?php if (! empty ( $this->_tpl_vars['tabindex'] )): ?>
                       tabindex="<?php echo $this->_tpl_vars['tabindex']; ?>
" <?php endif; ?>>
            </td>
        </tr>
